...
<br />
Folder contents<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-1-1.png)<br /><br />

Run frog.py. You need to move the frog through a maze to reach the statue.<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-1-2.png)<br /><br />

I didn't even read the code... just clicked randomly and you can get past here

| 1 | 2 |
| :---: | :---: |
| <img src="../../../assets/img/2024-FlareOn11/flareon2024-1-3.png" width="260"> | <img src="../../../assets/img/2024-FlareOn11/flareon2024-1-4.png" width="260"> |

![img](../../../assets/img/2024-FlareOn11/flareon2024-1-5.png)<br /><br />

![img](../../../assets/img/2024-FlareOn11/flareon2024-1-6.png)<br /><br />
...
<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-1.png)<br /><br />

Opening it up in IDA, we observe in function main_main, this will be our goal - to produce REAL_FLAREON_FLAG.JPG<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-2.png)<br /><br />

Starting near the top, you would want to go to the right path (green line) to continue and avoid the math.<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-3.png)<br /><br />

Edit > Patch program > Change byte<br />
Patch jge to jl<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-4.png)<br />
- Original<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-5.png)<br />
- New<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-6.png)<br /><br />

Now it only waits for an input<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-7.png)<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-8.png)<br /><br />

I initially tried to debug and patch everywhere to get the image file produced but it’s empty<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-9.png)<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-10.png)<br /><br />

From static analysis,
- It uses ChaCha20-Poly1305, which has a key length of 32, nonce 12 and tag 16.<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-11.png)<br />
- There is a main_encryptedFlagData, at offset main__gobytes_1 (addr 1ADA80 to 1D9FAB), which is size 2C52Ch.<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-12.png)<br />
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-13.png)<br />
- REAL_FLAREON_FLAG image file will be produced in %LocalAppData% path.<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-14.png)<br /><br />
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-15.png)<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-16.png)<br /><br />
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-17.png)<br /><br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-2-18.png)<br /><br />
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-4-1.png)<br /><br />
...
[Zip file](../../../assets/file/2024-FlareOn11/4-mememaker3000.zip)
...
- The function first retrieves the alt text of an image (from a0g) and splits it by /, taking the last part (using pop()).
  ...
  ![img](../../../assets/img/2024-FlareOn11/flareon2024-4-2.png)
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-4-3.png)<br /><br />
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-5-1.png)<br /><br />
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-5-2.png)
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-5-3.png)<br /><br />

The end of the decrypted output looks like this:<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-5-4.png)<br /><br />
...
int main()
{
	void *lib = dlopen("../../../assets/img/liblzma.so.5.4.1", RTLD_NOW);
	if (!lib)
	{
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-5-5.png)<br /><br />
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-5-6.png)
- 4 bytes input offset: 0x20048
![img](../../../assets/img/2024-FlareOn11/flareon2024-5-7.png)
- 32 + 12 bytes input offset: 0x20098, 0x200E0
![img](../../../assets/img/2024-FlareOn11/flareon2024-5-8.png)
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-5-9.png)<br /><br />
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-5-10.png)
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-5-11.png)<br /><br />
...
```
![img](../../../assets/img/2024-FlareOn11/flareon2024-5-12.png)<br /><br />
...
<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-6-1.png)<br />
...
$ make tests
```
![img](../../../assets/img/2024-FlareOn11/flareon2024-6-2.png)<br /><br />

Notice this TEST_VAL in data_mgr.v:<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-6-3.png)<br /><br />
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-6-4.png)<br /><br />

Upon running “make tests”, notice that in all iterations of the 3 test cases, tst is 0.<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-6-5.png)
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-6-6.png)<br /><br />

This is the output and you can clearly see that the tst values across the board are all 0s.<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-6-7.png)<br /><br />
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-6-8.png)<br /><br />
...
![img](../../../assets/img/2024-FlareOn11/flareon2024-6-9.png)<br /><br />

We can infer from the other lines where the finish signal is set correctly.<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-6-10.png)<br /><br />

Make the change accordingly.<br />
![img](../../../assets/img/2024-FlareOn11/flareon2024-6-11.png)<br /><br />

![img](../../../assets/img/2024-FlareOn11/flareon2024-6-12.png)<br /><br />
