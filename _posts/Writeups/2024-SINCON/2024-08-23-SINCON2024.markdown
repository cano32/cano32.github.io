...
![img](../../../assets/img/2024-SINCON/sincon2024-start.png)
- [1](#1)
- [2](#2)
- [3](#3)
- [4](#4)
...
<br />
Use Cyberchef:
![img](../../../assets/img/2024-SINCON/sincon2024-1-1.png)<br /><br />

![img](../../../assets/img/2024-SINCON/sincon2024-1-2.png)<br /><br />
...
<br />
![img](../../../assets/img/2024-SINCON/sincon2024-2-1.jpg)<br /><br />
...
![img](../../../assets/img/2024-SINCON/sincon2024-2-2.png)<br /><br />

Decode it with the tool [dcode pigpen cipher](https://www.dcode.fr/pigpen-cipher).
![img](../../../assets/img/2024-SINCON/sincon2024-2-3.png)<br /><br />

![img](../../../assets/img/2024-SINCON/sincon2024-2-4.png)<br /><br />
...
<br />
Use Cyberchef:
![img](../../../assets/img/2024-SINCON/sincon2024-3-1.png)<br /><br />

In the website [https://hackerware.io/cook1elog1c](https://hackerware.io/cook1elog1c):
![img](../../../assets/img/2024-SINCON/sincon2024-3-2.png)<br /><br />

Each image is of a bunch of logic gates and light bulbs.
- [cook1elog1c-1.png](../../../assets/img/2024-SINCON/cook1elog1c-1.png)<br />
- [cook1elog1c-2.png](../../../assets/img/2024-SINCON/cook1elog1c-2.png)<br />
- [cook1elog1c-3.png](../../../assets/img/2024-SINCON/cook1elog1c-3.png)<br />
- [cook1elog1c-4.png](../../../assets/img/2024-SINCON/cook1elog1c-4.png)<br />
...
| :---: | :---: |
| <img src="../../../assets/img/2024-SINCON/sincon2024-3-3.png" width="450"> | <img src="../../../assets/img/2024-SINCON/sincon2024-3-4.png" width="260"> |
| **cook1elog1c-3.png** | **cook1elog1c-4.png** |
| :---: | :---: |
| <img src="../../../assets/img/2024-SINCON/sincon2024-3-5.png" width="450"> | <img src="../../../assets/img/2024-SINCON/sincon2024-3-6.png" width="450"> |

Together, it gives 01100011 01100001 01101011 00110011. Use Cyberchef:
![img](../../../assets/img/2024-SINCON/sincon2024-3-7.png)<br /><br />

![img](../../../assets/img/2024-SINCON/sincon2024-3-8.png)<br /><br />
...
<br />
Use Cyberchef:
![img](../../../assets/img/2024-SINCON/sincon2024-4-1.png)<br /><br />

From the website [https://hackerware.io/cook1el4y3r.zip](https://hackerware.io/cook1el4y3r.zip):
- [cook1el4y3r.zip](../../../assets/file/2024-SINCON/cook1el4y3r.zip)<br /><br />
...
![img](../../../assets/img/2024-SINCON/sincon2024-4-2.png)<br /><br />

Use [Gerber online file viewer](https://www.pcbway.com/project/OnlineGerberViewer.html): 
![img](../../../assets/img/2024-SINCON/sincon2024-4-3.png)<br /><br />

While viewing layers:
![img](../../../assets/img/2024-SINCON/sincon2024-4-4.png)<br /><br />

When removing the yellow layer Badge_V1-B_Cu_Main.gbr, we see “ch3rry 0n b0tt0m”.
![img](../../../assets/img/2024-SINCON/sincon2024-4-5.png)<br /><br />

![img](../../../assets/img/2024-SINCON/sincon2024-4-6.png)<br /><br />
...
<br />
Use Cyberchef:
![img](../../../assets/img/2024-SINCON/sincon2024-5-1.png)<br /><br />

In the website [https://hackerware.io/cook1est3g4no](https://hackerware.io/cook1est3g4no):
![img](../../../assets/img/2024-SINCON/sincon2024-5-2.png)<br /><br />
...
- [cook1est3g4no.jpg](../../../assets/img/2024-SINCON/cook1est3g4no.jpg)

Using passphrase "cook1est3g4no":
![img](../../../assets/img/2024-SINCON/sincon2024-5-3.png)<br /><br />

![img](../../../assets/img/2024-SINCON/sincon2024-5-4.png)<br /><br />
...
![img](../../../assets/img/2024-SINCON/sincon2024-6-1.png)<br /><br />

![img](../../../assets/img/2024-SINCON/sincon2024-6-2.png)<br /><br />
...
![img](../../../assets/img/2024-SINCON/sincon2024-7-1.png)<br /><br />
...
<br />
Google:
![img](../../../assets/img/2024-SINCON/sincon2024-8-1.png)<br /><br />

Use this sus decryption tool hxxp://password-decrypt[.]com/:
![img](../../../assets/img/2024-SINCON/sincon2024-8-2.png)<br /><br />

![img](../../../assets/img/2024-SINCON/sincon2024-8-3.png)<br /><br />

Flag: ```give that man a cookie```<br /><br />

## yay

![img](../../../assets/img/2024-SINCON/sincon2024-end.png)<br /><br />

The badge:<br />
<img src="../../../assets/img/2024-SINCON/badge.gif" width="450">
