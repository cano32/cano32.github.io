...
Testing the output:
- No input
  ![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-1-1.png){: width="100%" }<br /><br />
- Input "aaa"
  ![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-1-2.png){: width="100%" }<br /><br />
...
![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-2-1.png){: width="100%" }<br /><br />

Go to Options > General… > Graph, and change “Max number of nodes” to 4096.
![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-2-2.png){: width="100%" }<br /><br />

Click “OK” and \<spacebar\> to change to the graph view.
![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-2-3.png){: width="100%" }<br /><br />

### Analysis Part 1
The program checks whether there is more than one argument.
![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-3-1.png){: width="100%" }<br /><br />

If there is no argument, it loads {flag_guess} to the output and exits.
![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-3-2.png){: width="100%" }<br /><br />

If there is an argument, the program will proceed to take it as an input.
![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-3-3.png){: width="100%" }<br /><br />

The rest of the code seems like a control flow graph.
![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-3-4.png){: width="100%" }<br /><br />
...
- When tracing it in the code above the comparison, the byte is 0.
  ![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-3-5.png){: width="100%" }
  ...
  ![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-3-6.png){: width="100%" }
  ...
  ![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-3-7.png){: width="100%" }
  <br /><br />

Moving on:
![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-3-8.png){: width="100%" }
...
![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-3-9.png){: width="100%" }
...
![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-3-10.png){: width="100%" }
...
![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-4-1.png){: width="100%" }
...
![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-4-2.png){: width="100%" }<br /><br />
...
- Following the comparison with "d":
  ...
  ![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-4-3.png){: width="100%" }
...
![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-4-4.png){: width="100%" }
...
![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-4-5.png){: width="100%" }<br /><br />
...
- If ( ( check_byte AND (char > "@" (40h) AND char <= "F" (46h)) ) \| (char > "`" (60h) AND char <= "f" (66h)) )<br />
  ...
  ![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-4-6.png){: width="100%" }
  - If ( char > ‘/’ (2Fh) OR char <= ‘9’ (39h) )<br />
    -> 0-9
    ![img](./2024-GreyCTF/PatternEnigmaMatrix/pem-4-7.png){: width="100%" }
